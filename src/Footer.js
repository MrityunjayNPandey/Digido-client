  ...
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    {/* </div> */}
      ...
      {/* <a class="flex title-font font-medium items-center md:justify-start justify-center text-white"> */}
        ...
        {/* <span class="ml-3 text-xl">Digido</span> */}
      {/* </a> */}
    ...
    <div class="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a class="text-gray-400 hover:text-white">Phone- 8283056888</a>
          </li>
          <li>
            <a class="text-gray-400 hover:text-white">E-mail- digidopvtltd@gmail.com</a>
          </li>
          <li>
            <a class="text-gray-400 hover:text-white">Address- Grand Omaxe, sec-93, NOIDA</a>
          </li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a class="text-gray-400 hover:text-white">Web-app based solutions</a>
          </li>
          <li>
            <a class="text-gray-400 hover:text-white">content based solutions</a>
          </li>
          <li>
            <a class="text-gray-400 hover:text-white">Database based solutions</a>
          </li>
